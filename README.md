# ESP-IDF + ST7789 (128x160) 俄罗斯方块示例

这是一个使用 **C 语言**、基于 **ESP-IDF** 的俄罗斯方块最小可运行示例，目标屏幕为 **ST7789**，分辨率 **128x160**。

## 功能说明

- SPI 驱动 ST7789（RGB565）
- 10x20 标准俄罗斯方块棋盘
- 7 种方块与旋转
- 消行逻辑
...
- `main/tetris_game.c`：ST7789 驱动 + 俄罗斯方块逻辑

## 注意事项

1. 部分 ST7789 模块需要设置 `MADCTL` 的方向位，请按你的屏幕方向调整。
